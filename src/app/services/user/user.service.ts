...
/* *******************************************
  ...
  setDefaultUserList():User[]{
    return [
      {
        userId:1,
        name:"Teboho Innocent Mosiea",
        username:"tebohomosiea",
        password:"Mosiea#369",
        address:{
          streetNumber:123,
          streetName: "Fricky Mayer",
          suite:"",
          city:"Daveton",
          state: "Johannesburg",
          country: "RSA",
      ...
      },
      {
        userId:2,
        name:"Mamo Semonyo",
        username:"mamosemonyo",
        password:"Semonyo#123",
        address:{
          streetNumber:643,
          streetName: "Bonke Thabi",
          suite:"",
          city:"Vereeniging",
          state: "Johannesburg",
          country: "RSA",
          zipcode:"1976"},
        email: "mamo.semonyo@kanza.com",
        isAdmin: false
      },
      {
        userId:3,
        name:"Jeanet Malebese",
        username:"jeanet45",
        password:"Malebese#369",
        address:{
          streetNumber:13,
          streetName: "Michaels Plains",
          suite:"Suite 879",
          city:"Cape Town",
          state: "",
          country: "RSA",
          zipcode:"1867"},
        email: "jeanetmalebese4567@meja.tv",
        isAdmin: false
      },
      {
        userId:4,
        name:"Thabo Clement",
        username:"clementt",
        password:"Clement#123",
        address:{
          streetNumber:71,
          streetName: "Zondo Make",
          suite:"",
          city:"Vanderbeijl",
          state: "",
          country: "RSA",
          zipcode:"1975"},
        email: "thaboc@yebo.net",
        isAdmin: false
      },
      {
        userId:5,
